...
const (
	...
	MediaService_GeneratePreview_FullMethodName = "/media.v1.MediaService/GeneratePreview"
)
...
type MediaServiceClient interface {
	...
	GeneratePreview(ctx context.Context, in *GeneratePreviewRequest, opts ...grpc.CallOption) (*GeneratePreviewResponse, error)
}
...
func (c *mediaServiceClient) GeneratePreview(ctx context.Context, in *GeneratePreviewRequest, opts ...grpc.CallOption) (*GeneratePreviewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GeneratePreviewResponse)
	err := c.cc.Invoke(ctx, MediaService_GeneratePreview_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MediaServiceServer interface {
	...
	GeneratePreview(context.Context, *GeneratePreviewRequest) (*GeneratePreviewResponse, error)
...
func (UnimplementedMediaServiceServer) GeneratePreview(context.Context, *GeneratePreviewRequest) (*GeneratePreviewResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GeneratePreview not implemented")
}
...
func _MediaService_GeneratePreview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GeneratePreviewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediaServiceServer).GeneratePreview(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediaService_GeneratePreview_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaServiceServer).GeneratePreview(ctx, req.(*GeneratePreviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MediaService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MediaService_GeneratePreview_Handler,
		},
	},
