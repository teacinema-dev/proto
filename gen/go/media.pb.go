...
const file_media_proto_rawDesc = "" +
	...
	"\x03Get\x12\x11.media.GetRequest\x1a\x12.media.GetResponse\x125\n" +
	"\x06Delete\x12\x14.media.DeleteRequest\x1a\x15.media.DeleteResponse\x12P\n" +
	"\x0fGeneratePreview\x12\x1d.media.GeneratePreviewRequest\x1a\x1e.media.GeneratePreviewResponseB5P\x01Z1github.com/teacinema-dev/proto/gen/go/media;mediab\x06proto3"
...
var file_media_proto_goTypes = []any{
	...
	(*GetRequest)(nil),              // 2: media.GetRequest
	(*GetResponse)(nil),             // 3: media.GetResponse
	(*DeleteRequest)(nil),           // 4: media.DeleteRequest
	(*DeleteResponse)(nil),          // 5: media.DeleteResponse
	(*GeneratePreviewRequest)(nil),  // 6: media.GeneratePreviewRequest
	(*GeneratePreviewResponse)(nil), // 7: media.GeneratePreviewResponse
}
var file_media_proto_depIdxs = []int32{
	0, // 0: media.MediaService.Upload:input_type -> media.UploadRequest
	2, // 1: media.MediaService.Get:input_type -> media.GetRequest
	4, // 2: media.MediaService.Delete:input_type -> media.DeleteRequest
	6, // 3: media.MediaService.GeneratePreview:input_type -> media.GeneratePreviewRequest
	1, // 4: media.MediaService.Upload:output_type -> media.UploadResponse
	3, // 5: media.MediaService.Get:output_type -> media.GetResponse
	5, // 6: media.MediaService.Delete:output_type -> media.DeleteResponse
	7, // 7: media.MediaService.GeneratePreview:output_type -> media.GeneratePreviewResponse
